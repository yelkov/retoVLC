...
def obtener_localizaciones(archivo_xspf):
    ...
    # Introducimos un bloque try except para el caso de que el .xspf esté vacío o corrompido
    try:
        ...
        raise ET.ParseError("El archivo .xspf introducido está vacío o es erróneo")
